	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark px-5">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item"><a class="nav-link" href="valoraciones">Valoraciones</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="cargarPartidos">Cargar
						Partidos</a></li>
				<li class="nav-item"><a class="nav-link" href="#">XXXXXX</a></li>
				<li class="nav-item"><a class="nav-link" href="login">Salir</a>
				</li>
			</ul>
		</div>
	</nav>
				...
				<div class="card w-100 mb-3">
					<div class="card-body">
						...
						<form action="datosPartido" method="POST" class="text-center">
							...
							<button class="btn btn-lg btn-primary font-weight-bold mb-2"
