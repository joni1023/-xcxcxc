	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<form action="registrarTorneo" method = "POST" modelAttribute="torneo">
					<input name="nombre" type="text" id="nombre" class="form-control mb-3" placeholder="Ingrese el nombre del torneo" required autofocus>
