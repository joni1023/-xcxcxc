...
-- Valoracion por peso y altura. Por ahora es igual pero los separe para tener posibilidad de cambiarlo
-- Arquero
 INSERT INTO `db`.`valoracionpesoaltura` (`altura`, `entre60y70`, `entre70y80`, `entre80y90`, `menos60`) VALUES ('menos150', '9.5', '7.0', '2.0', '10');
INSERT INTO `db`.`valoracionpesoaltura` (`altura`, `entre60y70`, `entre70y80`, `entre80y90`, `entre90y100`, `mas100`, `menos60`) VALUES ('entre150y160', '10', '9.0', '8.0', '6.0', '4.0', '9.5');
INSERT INTO `db`.`valoracionpesoaltura` (`altura`, `entre60y70`, `entre70y80`, `entre80y90`, `entre90y100`, `mas100`) VALUES ('entre160y170', '9.0', '10', '11', '8.0', '6.0');
INSERT INTO `db`.`valoracionpesoaltura` (`altura`, `entre60y70`, `entre70y80`, `entre80y90`, `entre90y100`, `mas100`) VALUES ('entre170y180', '9.5', '10', '11', '8.0', '7.0');
INSERT INTO `db`.`valoracionpesoaltura` (`altura`, `entre60y70`, `entre70y80`, `entre80y90`, `entre90y100`, `mas100`) VALUES ('entre180y190', '8.0', '9.5', '10', '9.5', '8.0');
INSERT INTO `db`.`valoracionpesoaltura` (`altura`, `entre70y80`, `entre80y90`, `entre90y100`, `mas100`) VALUES ('mas190', '8.0', '9.0', '9.5', '10');
-- Campo
INSERT INTO `db`.`valoracionpesoaltura` (`altura`, `entre60y70`, `entre70y80`, `entre80y90`, `menos60`) VALUES ('menos150', '9.5', '7.0', '2.0', '10');
INSERT INTO `db`.`valoracionpesoaltura` (`altura`, `entre60y70`, `entre70y80`, `entre80y90`, `entre90y100`, `mas100`, `menos60`) VALUES ('entre150y160', '10', '9.0', '8.0', '6.0', '4.0', '9.5');
INSERT INTO `db`.`valoracionpesoaltura` (`altura`, `entre60y70`, `entre70y80`, `entre80y90`, `entre90y100`, `mas100`) VALUES ('entre160y170', '9.0', '10', '11', '8.0', '6.0');
